...
const MainView: React.FC<MainViewProps> = ({
    ...
    return (
        <div className="flex w-full h-full">
            ...
            {/* Center Pane (always fills width, info pane only in cards/terminal mode) */}
            <div
                ...
                style={{
                    // When image viewer is open, fill entire area (no info pane)
            ...
            />
            {/* --- Info Pane only for cards or terminal (not for image viewer) --- */}
